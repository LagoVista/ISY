    ...
    public class Device : ModelBase
    {
        ...
        public String IconImage
        {
            get
            {
                ...
                {
                    case DeviceType.DeviceCateogry.Thermostat: return "ms-appx:///LagoVista.Common.UI.ISY/Images/Temperature.png";
                    case DeviceType.DeviceCateogry.OutdoorModule: return "ms-appx:///LagoVista.Common.UI.ISY/Images/OutdoorSwitch.png";
                    case DeviceType.DeviceCateogry.MotionDetector: return "ms-appx:///LagoVista.Common.UI.ISY/Images/MotionDetector.png";
                    case DeviceType.DeviceCateogry.InlineSwitch: return "ms-appx:///LagoVista.Common.UI.ISY/Images/Outlet.png";
                    case DeviceType.DeviceCateogry.DimmableModule: return "ms-appx:///LagoVista.Common.UI.ISY/Images/Lamp.png";
                    case DeviceType.DeviceCateogry.LEDLightBulb: return "ms-appx:///LagoVista.Common.UI.ISY/Images/LightBulb.png";
                    case DeviceType.DeviceCateogry.LoadController: return "ms-appx:///LagoVista.Common.UI.ISY/Images/LoadController.png";
                    case DeviceType.DeviceCateogry.MultiSwitch: return "ms-appx:///LagoVista.Common.UI.ISY/Images/MultiSwitch.png";
                    case DeviceType.DeviceCateogry.FanLight: return "ms-appx:///LagoVista.Common.UI.ISY/Images/FanLight.png";
                    case DeviceType.DeviceCateogry.FanMotor: return "ms-appx:///LagoVista.Common.UI.ISY/Images/Fan.png";
                    case DeviceType.DeviceCateogry.ContactSwitch: return "ms-appx:///LagoVista.Common.UI.ISY/Images/ContactSwitch.png";
                    case DeviceType.DeviceCateogry.ToggleSwitch: return "ms-appx:///LagoVista.Common.UI.ISY/Images/ToggleSwitch.png";
                    case DeviceType.DeviceCateogry.Unknown: return "ms-appx:///LagoVista.Common.UI.ISY/Images/QuestionMark.png";
                }
        ...
        public String StatusDisplay
        {
            ...
            {
                if (Status.ToLower() == "updating")
                    return Resources.ISYStringResources.ISY_Common_Updating;
                ...
                switch (DeviceType.DeviceCategory)
                {
                    ...
                    case DeviceType.DeviceCateogry.FanMotor:
                        switch (Status)
                        {
                            case "0": statusValue = Resources.ISYStringResources.ISY_Common_Off; break;
                            case "63": statusValue = Resources.ISYStringResources.ISY_Fan_Low; break;
                            case "191": statusValue = Resources.ISYStringResources.ISY_Fan_Medium; break;
                            case "255": statusValue = Resources.ISYStringResources.ISY_Fan_High; break;
                        }
                        break;
                    ...
                    case DeviceType.DeviceCateogry.DimmableModule:
                        ...
                        {
                            if (percentOn == 0)
                                statusValue = Resources.ISYStringResources.ISY_Common_Off;
                            else if (percentOn == 255)
                                statusValue = Resources.ISYStringResources.ISY_Common_On;
                            else
                    ...
                    case DeviceType.DeviceCateogry.ContactSwitch:
                        if (Status == "0")
                            statusValue = Resources.ISYStringResources.ISY_Common_Closed;
                        else if (Status == "255")
                            statusValue = Resources.ISYStringResources.ISY_Common_Open;
                ...
                return String.Format("{0}: {1}", Resources.ISYStringResources.ISY_Common_Status, statusValue);
            }
        }
        ...
        public async void SendCommand(String command, Object parameter = null)
        {
            ...
            Status = Resources.ISYStringResources.ISY_Common_Updating;
